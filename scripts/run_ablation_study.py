...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--ablation_names", type=str, default=None, help="Comma separated ablation names")
...
def run_single_ablation(
    ...
    out_dir = results_root / dataset_name / ablation.name / f"seed_{seed}"
    _ensure_dir(out_dir)
    ...
    for dataset in datasets:
        for ablation_name in ablations:
            for seed in seeds:
                ...
                run_single_ablation(dataset, ablation_name, seed, cfg, device, force, results_root)
